...
function Controller() {
    ...
    $.__views.briefsView.add($.__views.__alloyId67);
    ...
    $.__views.__alloyId67.add($.__views.backButton);
    ...
    $.__views.__alloyId67.add($.__views.headerLabel);
    ...
    $.__views.briefsView.add($.__views.__alloyId68);
    ...
    $.__views.__alloyId68.add($.__views.briefBB);
    ...
    __alloyId69.push($.__views.latest);
    $.__views.__alloyId70 = Alloy.createController("brief", {
        LoadGallery: true,
        id: "__alloyId70",
        __parentSymbol: $.__views.latest
    });
    $.__views.__alloyId70.setParent($.__views.latest);
    $.__views.faves = Ti.UI.createView({
        id: "faves"
    });
    __alloyId69.push($.__views.faves);
    $.__views.__alloyId71 = Alloy.createController("brief", {
        loadGallery: false,
        id: "__alloyId71",
        __parentSymbol: $.__views.faves
    });
    $.__views.__alloyId71.setParent($.__views.faves);
    $.__views.ending = Ti.UI.createView({
        id: "ending"
    });
    __alloyId69.push($.__views.ending);
    $.__views.__alloyId72 = Alloy.createController("brief", {
        loadGallery: false,
        id: "__alloyId72",
        __parentSymbol: $.__views.ending
    });
    $.__views.__alloyId72.setParent($.__views.ending);

...
function Controller() {
    ...
    $.__views.tableViewRow.add($.__views.__alloyId73);
    ...
    $.__views.featuredUserThumb.setParent($.__views.__alloyId79);
    ...
    $.__views.__alloyId80.add($.__views.followingNodeLabel);
    ...
    $.__views.__alloyId80.add($.__views.followingNodeUser);
    ...
    $.__views.__alloyId79.add($.__views.followButton);
    ...
    $.__views.__alloyId79.add($.__views.followingUserButton);
    ...
    $.__views.tableViewRow.add($.__views.__alloyId81);
    ...
    $.__views.nodeThumb.setParent($.__views.__alloyId81);
    ...
    $.__views.__alloyId82.add($.__views.featuerdNodeLabel);
    ...
    shareVideo ? $.addListener($.__views.__alloyId83, "click", shareVideo) : __defers["$.__views.__alloyId83!click!shareVideo"] = true;
    ...
    starVideo ? $.addListener($.__views.__alloyId84, "click", starVideo) : __defers["$.__views.__alloyId84!click!starVideo"] = true;
    ...
    $.__views.__alloyId85.add($.__views.closeShare);
    ...
    $.__views.__alloyId85.add($.__views.facebook);
    ...
    $.__views.__alloyId85.add($.__views.twitter);
    ...
    $.__views.__alloyId85.add($.__views.linkedIn);
    ...
    $.__views.__alloyId85.add($.__views.approveShare);
    ...
    __defers["$.__views.__alloyId83!click!shareVideo"] && $.addListener($.__views.__alloyId83, "click", shareVideo);
    __defers["$.__views.__alloyId84!click!starVideo"] && $.addListener($.__views.__alloyId84, "click", starVideo);

...
function Controller() {
    ...
    $.__views.featuredView.add($.__views.__alloyId91);
    $.__views.tableView = Ti.UI.createView({
        id: "tableView"
    });
    $.__views.__alloyId91.add($.__views.tableView);
    ...
    $.__views.__alloyId91.add($.__views.noResults);
    ...
    $.__views.noResults.add($.__views.__alloyId93);

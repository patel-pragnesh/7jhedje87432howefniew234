...
function Controller() {
    ...
    $.__views.tableViewRow.add($.__views.__alloyId94);
    ...
    $.__views.infoCategoryIcon.setParent($.__views.__alloyId94);
    ...
    $.__views.__alloyId96.add($.__views.infoTag);
    ...
    $.__views.featuredUserThumb.setParent($.__views.__alloyId98);
    ...
    $.__views.__alloyId99.add($.__views.followingNodeLabel);
    ...
    $.__views.__alloyId99.add($.__views.followingNodeUser);
    ...
    $.__views.__alloyId98.add($.__views.followButton);
    ...
    $.__views.__alloyId98.add($.__views.followingUserButton);
    ...
    $.__views.tableViewRow.add($.__views.__alloyId100);
    ...
    $.__views.nodeThumb.setParent($.__views.__alloyId100);
    ...
    $.__views.__alloyId101.add($.__views.featuredNodeLabel);
    ...
    $.__views.__alloyId101.add($.__views.featuredNodeViews);
    ...
    shareVideo ? $.addListener($.__views.__alloyId102, "click", shareVideo) : __defers["$.__views.__alloyId102!click!shareVideo"] = true;
    ...
    starVideo ? $.addListener($.__views.__alloyId103, "click", starVideo) : __defers["$.__views.__alloyId103!click!starVideo"] = true;
    ...
    $.__views.__alloyId104.add($.__views.closeShare);
    ...
    $.__views.__alloyId104.add($.__views.facebook);
    ...
    $.__views.__alloyId104.add($.__views.twitter);
    ...
    $.__views.__alloyId104.add($.__views.linkedIn);
    ...
    $.__views.__alloyId104.add($.__views.approveShare);
    ...
    __defers["$.__views.__alloyId102!click!shareVideo"] && $.addListener($.__views.__alloyId102, "click", shareVideo);
    __defers["$.__views.__alloyId103!click!starVideo"] && $.addListener($.__views.__alloyId103, "click", starVideo);

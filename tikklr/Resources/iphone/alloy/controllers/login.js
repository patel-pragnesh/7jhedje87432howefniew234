...
function Controller() {
    ...
    $.__views.loginWindow.add($.__views.__alloyId124);
    $.__views.logoMain = Alloy.createController("login/logo", {
        id: "logoMain",
        __parentSymbol: $.__views.__alloyId124
    });
    $.__views.logoMain.setParent($.__views.__alloyId124);
    var __alloyId125 = [];
    ...
    __alloyId125.push($.__views.loginView);
    ...
    $.__views.loginView.add($.__views.__alloyId127);
    ...
    $.__views.__alloyId127.add($.__views.password);
    ...
    forgotPassword ? $.addListener($.__views.__alloyId128, "click", forgotPassword) : __defers["$.__views.__alloyId128!click!forgotPassword"] = true;
    ...
    $.__views.loginView.add($.__views.__alloyId129);
    ...
    $.__views.__alloyId129.add($.__views.loginButton);
    ...
    $.__views.loginView.add($.__views.__alloyId130);
    ...
    $.__views.__alloyId130.add($.__views.registerButton);
    ...
    __alloyId125.push($.__views.demoYou);
    $.__views.__alloyId131 = Alloy.createController("demo/you", {
        id: "__alloyId131",
        __parentSymbol: $.__views.demoYou
    });
    $.__views.__alloyId131.setParent($.__views.demoYou);
    $.__views.demoShot = Ti.UI.createView({
        id: "demoShot"
    });
    __alloyId125.push($.__views.demoShot);
    $.__views.__alloyId132 = Alloy.createController("demo/shot", {
        id: "__alloyId132",
        __parentSymbol: $.__views.demoShot
    });
    $.__views.__alloyId132.setParent($.__views.demoShot);
    $.__views.demoBrandsPay = Ti.UI.createView({
        id: "demoBrandsPay",
        last: true
    });
    __alloyId125.push($.__views.demoBrandsPay);
    $.__views.__alloyId133 = Alloy.createController("demo/brandsPay", {
        id: "__alloyId133",
        __parentSymbol: $.__views.demoBrandsPay
    });
    $.__views.__alloyId133.setParent($.__views.demoBrandsPay);
    ...
    $.__views.__alloyId124.add($.__views.loginScroll);
    ...
    $.__views.__alloyId124.add($.__views.registerView);
    $.__views.__alloyId135 = Alloy.createController("login/register", {
        id: "__alloyId135",
        __parentSymbol: $.__views.registerView
    });
    $.__views.__alloyId135.setParent($.__views.registerView);
    $.__views.forgotPassView = Ti.UI.createView({
        id: "forgotPassView"
    });
    $.__views.__alloyId124.add($.__views.forgotPassView);
    $.__views.__alloyId136 = Alloy.createController("login/forgot", {
        id: "__alloyId136",
        __parentSymbol: $.__views.forgotPassView
    });
    $.__views.__alloyId136.setParent($.__views.forgotPassView);
    ...
    $.__views.__alloyId137 = Alloy.createController("loading", {
        id: "__alloyId137",
        __parentSymbol: $.__views.loginLoading
    });
    $.__views.__alloyId137.setParent($.__views.loginLoading);
    ...
    __defers["$.__views.__alloyId128!click!forgotPassword"] && $.addListener($.__views.__alloyId128, "click", forgotPassword);

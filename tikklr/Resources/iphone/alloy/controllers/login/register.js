...
function Controller() {
    ...
    $.__views.__alloyId366.add($.__views.email);
    ...
    $.__views.registerView.add($.__views.__alloyId367);
    ...
    termsClicked ? $.addListener($.__views.__alloyId369, "singletap", termsClicked) : __defers["$.__views.__alloyId369!singletap!termsClicked"] = true;
    ...
    $.__views.__alloyId368.add($.__views.termsSwitch);
    ...
    $.__views.registerView.add($.__views.__alloyId370);
    ...
    $.__views.__alloyId370.add($.__views.loginTerms);
    ...
    $.__views.__alloyId370.add($.__views.loginTermsLink);
    ...
    $.__views.registerView.add($.__views.__alloyId371);
    ...
    $.__views.__alloyId371.add($.__views.registerButton);
    ...
    __defers["$.__views.__alloyId369!singletap!termsClicked"] && $.addListener($.__views.__alloyId369, "singletap", termsClicked);

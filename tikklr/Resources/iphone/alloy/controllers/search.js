...
function Controller() {
    ...
    $.__views.searchView.add($.__views.__alloyId274);
    ...
    backClicked ? $.addListener($.__views.__alloyId275, "click", backClicked) : __defers["$.__views.__alloyId275!click!backClicked"] = true;
    ...
    __alloyId277.push($.__views.hashSearch);
    $.__views.__alloyId278 = Alloy.createController("search/hash", {
        id: "__alloyId278",
        __parentSymbol: $.__views.hashSearch
    });
    $.__views.__alloyId278.setParent($.__views.hashSearch);
    $.__views.peopleSearch = Ti.UI.createView({
        id: "peopleSearch"
    });
    __alloyId277.push($.__views.peopleSearch);
    $.__views.__alloyId279 = Alloy.createController("search/people", {
        loadGallery: false,
        id: "__alloyId279",
        __parentSymbol: $.__views.peopleSearch
    });
    $.__views.__alloyId279.setParent($.__views.peopleSearch);
    $.__views.briefsSearch = Ti.UI.createView({
        id: "briefsSearch"
    });
    __alloyId277.push($.__views.briefsSearch);
    $.__views.__alloyId280 = Alloy.createController("search/brief", {
        loadGallery: false,
        id: "__alloyId280",
        __parentSymbol: $.__views.briefsSearch
    });
    $.__views.__alloyId280.setParent($.__views.briefsSearch);
    ...
    __defers["$.__views.__alloyId275!click!backClicked"] && $.addListener($.__views.__alloyId275, "click", backClicked);
    _.extend($, exports);
}

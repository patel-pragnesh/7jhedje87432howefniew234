...
function Controller() {
    ...
    $.__views.hashSearch.add($.__views.__alloyId466);
    ...
    $.__views.__alloyId466.add($.__views.search);
    $.__views.search.add($.__views.__alloyId467);
    ...
    $.__views.hashSearch.add($.__views.__alloyId468);
    $.__views.tableView = Ti.UI.createView({
        id: "tableView"
    });
    $.__views.__alloyId468.add($.__views.tableView);
    ...
    $.__views.__alloyId468.add($.__views.noResults);
    ...
    $.__views.noResults.add($.__views.__alloyId470);

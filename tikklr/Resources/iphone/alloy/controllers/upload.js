...
function Controller() {
    function __alloyId346(e) {
        if (e && e.fromAdapter) return;
        __alloyId346.opts || {};
        var models = __alloyId345.models;
        var len = models.length;
        var rows = [];
        for (var i = 0; len > i; i++) {
            var __alloyId338 = models[i];
            __alloyId338.__transform = _.isFunction(__alloyId338.transform) ? __alloyId338.transform() : __alloyId338.toJSON();
            var __alloyId340 = Ti.UI.createTableViewRow({
                backgroundColor: Alloy.Globals.TikklrBlack,
                height: "30",
                layout: "absolute"
            });
            rows.push(__alloyId340);
            var __alloyId342 = Ti.UI.createLabel({
                ...
                text: _.template("{m.title}", {
                    m: __alloyId338.__transform
                }, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            });
            __alloyId340.add(__alloyId342);
            var __alloyId344 = Ti.UI.createView({
                right: "5",
                width: "30",
                height: "30",
            ...
            __alloyId340.add(__alloyId344);
        }
        $.__views.__alloyId337.setData(rows);
    }
    ...
    $.__views.tikklrHeader.add($.__views.__alloyId333);
    ...
    $.__views.imageContainer.add($.__views.__alloyId334);
    ...
    $.__views.__alloyId334.add($.__views.title);
    ...
    $.__views.imageContainer.add($.__views.__alloyId335);
    ...
    $.__views.__alloyId335.add($.__views.tags);
    ...
    $.__views.imageContainer.add($.__views.__alloyId336);
    ...
    $.__views.__alloyId336.add($.__views.category);
    ...
    $.__views.__alloyId337 = Ti.UI.createTableView({
        separatorColor: "transparent",
        backgroundColor: Alloy.Globals.TikklrGreen,
        rowHeight: "30",
        id: "__alloyId337"
    });
    $.__views.categoryPicker.add($.__views.__alloyId337);
    var __alloyId345 = Alloy.Collections["$.Categories"] || $.Categories;
    __alloyId345.on("fetch destroy change add remove reset", __alloyId346);
    ...
    $.Kaltura.on("fetch change destroy", __alloyId347);
    exports.destroy = function() {
        __alloyId345 && __alloyId345.off("fetch destroy change add remove reset", __alloyId346);
        $.Kaltura && $.Kaltura.off("fetch change destroy", __alloyId347);
    };
    _.extend($, $.__views);
    var givenTags = "";
    var title = "";

...
module.exports = [ {
    isClass: true,
    priority: 10000.900099999999,
    key: "followingTableInnerBox",
    style: {
        top: 5,
        left: 5,
        right: 5,
    ...
    isClass: true,
    priority: 10000.909,
    key: "icon-wheel-settings-live",
    style: {
        backgroundImage: "wheelSettingsLive.png"
    }
}, {
    isClass: true,
    priority: 10000.909099999999,
    key: "icon-wheel-search-live",
    style: {
        backgroundImage: "wheelSearchLive.png"
    }
}, {
    isClass: true,
    priority: 10000.9092,
    key: "icon-wheel-brief-live",
    style: {
        backgroundImage: "wheelBriefLive.png"
    }
}, {
    isClass: true,
    priority: 10000.9093,
    key: "icon-wheel-inbox",
    style: {
        backgroundImage: "wheelMessages.png"
    }
}, {
    isClass: true,
    priority: 10000.9094,
    key: "icon-wheel-inbox-live",
    style: {
        backgroundImage: "wheelMessagesLive.png"
    }
}, {
    isClass: true,
    priority: 10000.9095,
    key: "icon-wheel-rewards-live",
    style: {
        backgroundImage: "wheelRewardsLive.png"
    }
}, {
    isClass: true,
    priority: 10000.909599999999,
    key: "icon-wheel-profile-live",
    style: {
        backgroundImage: "wheelProfileLive.png"
    }
}, {
    isClass: true,
    priority: 10000.9097,
    key: "icon-wheel-discover-live",
    style: {
        backgroundImage: "wheelDiscoverLive.png"
    }
}, {
    isClass: true,
    priority: 10000.9098,
    key: "icon-wheel-create-live",
    style: {
        backgroundImage: "wheelCreateLive.png"
    }
}, {
    isClass: true,
    ...
    style: {
        ...
        selectedBackgroundImage: "close-pressed.png"
    }
}, {
    isClass: true,
    priority: 10000.9102,
    ...
    isClass: true,
    priority: 10000.9105,
    key: "icon-film-roll-pressed",
    style: {
        backgroundImage: "film-roll-pressed.png"
    }
}, {
    isClass: true,
    priority: 10000.9106,

...
function Controller() {
    ...
    $.__views.menuWin.add($.__views.__alloyId276);
    ...
    backClicked ? $.addListener($.__views.__alloyId277, "click", backClicked) : __defers["$.__views.__alloyId277!click!backClicked"] = true;
    ...
    __alloyId280.push($.__views.__alloyId283);
    ...
    $.__views.__alloyId283.add($.__views.name);
    ...
    __alloyId280.push($.__views.__alloyId284);
    ...
    $.__views.__alloyId284.add($.__views.mail);
    ...
    __alloyId280.push($.__views.__alloyId285);
    ...
    $.__views.__alloyId285.add($.__views.firstName);
    ...
    __alloyId280.push($.__views.__alloyId286);
    ...
    __alloyId280.push($.__views.__alloyId287);
    ...
    $.__views.__alloyId287.add($.__views.location);
    ...
    __alloyId280.push($.__views.__alloyId288);
    ...
    __alloyId280.push($.__views.__alloyId290);
    ...
    logout ? $.addListener($.__views.__alloyId291, "click", logout) : __defers["$.__views.__alloyId291!click!logout"] = true;
    ...
    $.__views.sectionEditProfile = Ti.UI.createTableViewSection({
        headerView: $.__views.__alloyId293,
        id: "sectionEditProfile"
    });
    __alloyId280.push($.__views.sectionEditProfile);
    $.__views.__alloyId295 = Ti.UI.createTableViewRow({
        id: "__alloyId295"
    });
    $.__views.sectionEditProfile.add($.__views.__alloyId295);
    ...
    gotoUrl ? $.addListener($.__views.__alloyId296, "click", gotoUrl) : __defers["$.__views.__alloyId296!click!gotoUrl"] = true;
    ...
    __alloyId280.push($.__views.sectionDelete);
    $.__views.__alloyId300 = Ti.UI.createTableViewRow({
        id: "__alloyId300"
    });
    $.__views.sectionDelete.add($.__views.__alloyId300);
    ...
    $.__views.__alloyId279 = Ti.UI.createTableView({
    ...
    $.__views.menuWin.add($.__views.__alloyId279);
    var __alloyId312 = function() {
    ...
    $.User.on("fetch change destroy", __alloyId312);
    exports.destroy = function() {
        $.User && $.User.off("fetch change destroy", __alloyId312);
    };
    _.extend($, $.__views);
    $.saveButton.setTouchEnabled(true);
    ...
    __defers["$.__views.__alloyId277!click!backClicked"] && $.addListener($.__views.__alloyId277, "click", backClicked);
    ...
    __defers["$.__views.__alloyId291!click!logout"] && $.addListener($.__views.__alloyId291, "click", logout);
    __defers["$.__views.__alloyId296!click!gotoUrl"] && $.addListener($.__views.__alloyId296, "click", gotoUrl);
